...
class QPageView(APIView):
    ...
    def get(self, request):
        ...
        if page < 2:
            tagList = [
                ['Wellness', 'Fitness', 'Nutrition', 'Exercise', 'Healthy lifestyle', 'Medical', 'Well-being',
                 'Healthcare',
                 'Mental health', 'Diet', 'Physical fitness', 'Healthy living', 'Holistic health', 'Preventive care',
                 'Natural remedies', 'Wellness tips', 'Healthcare advice', 'Mind-body balance', 'Healthy habits',
                 'Self-care', ],
                ['Job opportunities', 'Employment', 'Professional development', 'Career growth', 'Job search',
                 'Career advancement', 'Occupation', 'Work opportunities', 'Career path', 'Job market',
                 'Career planning',
                 'Job prospects', 'Career exploration', 'Occupational skills', 'Job openings', 'Employment trends',
                 'Career guidance', 'Job satisfaction', 'Career success', 'Job hunting', ],
                ['Learning', 'School', 'Knowledge', 'Study', 'Training', 'Academic', 'Classroom', 'Tutoring', 'College',
                 'E-learning', 'Educational resources', 'Student', 'Curriculum', 'Instruction', 'Teaching',
                 'Online courses', 'Skill development', 'Higher education', 'Educational technology',
                 'Learning resources', ],
                ['Real estate', 'Homeownership', 'Property', 'Housing market', 'Mortgage', 'Rental',
                 'Affordable housing',
                 'Residential', 'Housing options', 'Housing affordability', 'Property values', 'Housing development',
                 'Housing trends', 'Housing solutions', 'Housing finance', 'Housing assistance', 'Urban housing',
                 'Suburban living', 'Rental properties', 'Housing crisis', ],
                ['Well-being', 'Healthy living', 'Wellness', 'Balanced lifestyle', 'Personal development', 'Self-care',
                 'Fitness', 'Leisure', 'Hobbies', 'Mindfulness', 'Relaxation', 'Stress management', 'Nutrition',
                 'Mind-body balance', 'Social activities', 'Work-life balance', 'Outdoor activities',
                 'Self-improvement',
                 'Healthy habits', 'Quality of life', ],
                ['Style', 'Trends', 'Apparel', 'Clothing', 'Couture', 'Fashionable', 'Runway', 'Accessories',
                 'Designer',
                 'Wardrobe', 'Chic', 'Glamour', 'Trendsetter', 'Street style', 'Haute couture', 'Fashion industry',
                 'Fashionista', 'Modelling', 'Vintage fashion', 'Fashion show', ],
                ['Legal', 'Justice', 'Legislation', 'Attorney', 'Legal system', 'Court', 'Jurisprudence',
                 'Legal advice',
                 'Regulations', 'Legal rights', 'Litigation', 'Legal practice', 'Criminal law', 'Civil law',
                 'Legal proceedings', 'Legal counsel', 'Constitutional law', 'Legal framework', 'Legal code',
                 'Legal profession', ],
                ['Gaming', 'Video games', 'Board games', 'Online games', 'Gaming community', 'Console gaming',
                 'Esports',
                 'Gaming industry', 'Game development', 'Mobile games', 'Gaming culture', 'Game enthusiasts',
                 'Multiplayer games', 'Gaming platform', 'Gaming trends', 'Game strategy', 'Gaming technology',
                 'Game streaming', 'Virtual reality games', 'Casual games', ],
                ['Television series', 'TV programs', 'Entertainment', 'Streaming shows', 'TV channels', 'Drama series',
                 'Reality TV', 'Sitcoms', 'TV episodes', 'Television production', 'Broadcast', 'Series finale',
                 'TV network', 'Prime time', 'TV drama', 'TV ratings', 'Talk shows', 'TV streaming',
                 'Television industry',
                 'Cable TV', ]]
